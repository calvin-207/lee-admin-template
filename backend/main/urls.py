...
from system.views.frontend import h5web
...
if settings.DEBUG:
    ...
    urlpatterns += [
        path(
            ...
            name="swagger-ui",
        ),  # api/schema/lyjson/有认证情况下，需要去除lyjson接口认证，否则报错
        path(
            "api/schema/redoc/",
...
urlpatterns += [
    ...
    path('api/leemessages/', include('apps.leemessages.urls')),
...
urlpatterns += [
    ...
    path(
        "",
        TemplateView.as_view(template_name="leeadmin/index.html"),
        name="后台管理默认页面",
    ),
]
