        ...
        if appname_list:
            for name in appname_list:
                ...
                if os.path.exists(app_path):
                    ...
                    # 创建__init__.py文件
                    with open(
                        os.path.join(app_path, "__init__.py"), "a", encoding="UTF-8"
                    ) as f:
                        pass
                    ...
                    with open(
                        os.path.join(migrations_path, "__init__.py"),
                        "a",
                        encoding="UTF-8",
                    ) as f:
                        pass
...
"""
                    with open(
                        os.path.join(app_path, "apps.py"), "w", encoding="UTF-8"
                    ) as f:
...
"""
                    with open(
                        os.path.join(app_path, "models.py"), "a", encoding="UTF-8"
                    ) as f:
...
"""
                    with open(
                        os.path.join(app_path, "views.py"), "a", encoding="UTF-8"
                    ) as f:
...
"""
                    with open(
                        os.path.join(app_path, "urls.py"), "a", encoding="UTF-8"
                    ) as f:
            ...
            print(f"请输入要创建的app名称如：python manage.py leeadminstartapp app名")
