        ...
        <el-dialog v-model="passwordDialogVisible" title="修改密码" width="50%" :fullscreen="isMobile" :close-on-click-modal="false">
            <el-form :model="passwordForm" :rules="passwordRules" ref="passwordFormRef" label-width="100px">
                ...
                <el-form-item label="新密码" prop="newPassword">
                    ...
                    <LeePasswordStrength v-model="passwordForm.newPassword"></LeePasswordStrength>
...
<script setup name="PersonalCenter">
    ...
    import defaultAvatar from '@/assets/lee/imgs/avatar.jpg'
    import Api from '@/api/api.js'
    import LeePasswordStrength from "@/components/password/leePasswordStrength.vue";
